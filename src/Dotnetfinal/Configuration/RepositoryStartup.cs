...
using Scrutor;
using Dotnetfinal.Domain.Entities;
using Dotnetfinal.Domain.Repositories.Interfaces;
using Dotnetfinal.Infrastructure.Data.Repositories;

namespace Dotnetfinal.Configuration;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("Dotnetfinal.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("Dotnetfinal.Infrastructure.Data.Repositories") &&
